...
/*
 * This header provides constants for the Intel 64-bit SoCFPGA pinctrl bindings.
 *
 * Copyright (C) 2023, Intel Corporation
 */

#ifndef _DT_BINDINGS_PINCTRL_SOCFPGA_H
#define _DT_BINDINGS_PINCTRL_SOCFPGA_H
